...
from libc.math cimport sqrt,exp,log,fabs,M_PI
...
# -----------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------------------------
# Function to compute the error function as defined by its Maclaurin series
# for a real scalar argument.
# Parameters:
# ---x        : float value with the real value to evaluate.
# Returns:
