...
ap.add_argument("-DIST_T"    ,  "--DISTRIBUTION_TYPE", required = True, help="Polylogarithmic exponential (1); Shifted-geometric exponential (2); Polylogarithmic and shifted-geometric exp. vs 1st and 2nd order models (for same plot comparison) (3).")
